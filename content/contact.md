...
<section class="lg:pb-24">
  <div class="max-w-screen-md px-4 mx-auto">
      <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">Looking for OpenAI Custom GPT Development Service? Contact us.</p>
      <form id="contact-form" name="contact" action="javascript:void(0);" class="space-y-8">
          ...
          <div class="my-4 sm:col-span-2">
              <label for="message" class="block mb-2 font-medium text-gray-900 text-md dark:text-gray-400"><strong>Your ideas:</strong></label>
